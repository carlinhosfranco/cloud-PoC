...
plot './mem_Add.dat' using 1:2:xtic(1) with boxes ls 6 title "ADD" axes x1y1, '' using 1:2:3 with errorbars ls 1 title "Erro"
...
plot './mem_Copy.dat' using 1:2:xtic(1) with boxes ls 3 title "Copy" axes x1y1, '' using 1:2:3 with errorbars ls 1 title "Erro"
...
plot './mem_Scale.dat' using 1:2:xtic(1) with boxes ls 4 title "Scale" axes x1y1, '' using 1:2:3 with errorbars ls 1 title "Erro"
...
plot './mem_Triad.dat' using 1:2:xtic(1) with boxes ls 5 title "Triad" axes x1y1, '' using 1:2:3 with errorbars ls 1 title "Erro"
