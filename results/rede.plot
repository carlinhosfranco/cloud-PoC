...
set key inside top left vertical nobox font 'Helvetica,12'
set title "Uperf" offset -2,-1,1
set ylabel "Mb/s" offset 1,1,1
set xlabel "Threads"
...
plot './native/net_uperf.dat' using 1:2:xtic(1) with boxes ls 6 title "Throughput" axes x1y1, '' using 1:2:3 with errorbars ls 1 title "Erro"
